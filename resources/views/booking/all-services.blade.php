...
<body class="bg-gray-50 text-gray-800 antialiased min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-6xl mx-auto w-full py-16 px-4">
        ...
        <div class="mb-10 text-center flex flex-col items-center">
            <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight mb-4">Semua Layanan Paket Foto
            </h1>
            <p class="text-gray-500 text-sm md:text-base max-w-2xl mx-auto">
                Jelajahi seluruh pilihan paket foto yang kami tawarkan. Temukan yang paling cocok untuk mengabadikan
                momen spesial Anda.
            </p>
        </div>

        {{-- Pemisah Garis "PAKET FOTO" --}}
        <div class="flex items-center justify-center w-full mb-10 opacity-70">
            <div class="h-px bg-gray-300 w-16 md:w-24"></div>
            <span class="px-4 text-brand font-bold text-xs md:text-sm tracking-[0.2em] uppercase">Paket Foto</span>
            <div class="h-px bg-gray-300 w-16 md:w-24"></div>
        </div>
                ...
                @foreach($services as $service)
                    ...
                    <div
                        ...
                        <div class="flex-grow">
                            ...
                            {{-- Deskripsi (dibatasi agar seragam) --}}
                            @if($service->description)
                                <p class="text-sm text-gray-500 mb-4 whitespace-pre-line line-clamp-4">{{ $service->description }}
                                </p>
                            @endif
                        </div>
        ...
        {{-- SECTION KONSULTASI (DIBERI JARAK ATAS YANG SIGNIFIKAN AGAR TIDAK MEPET) --}}
        <div class="pt-28 pb-12 text-center flex flex-col items-center justify-center">
