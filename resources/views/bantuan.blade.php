...
<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 bg-[#f5f7fb] min-h-screen overflow-x-hidden">
        ...
        <!-- Header Halaman -->
        <div class="mb-7">
            <h1 class="text-2xl font-extrabold text-gray-900 tracking-tight">Pusat Bantuan & Panduan Sistem</h1>
            <p class="text-sm text-gray-500 mt-1">
                Ikuti langkah-langkah di bawah ini untuk mengonfigurasi dan mengoperasikan sistem booking fotografi Anda secara terstruktur.
            </p>
        </div>
