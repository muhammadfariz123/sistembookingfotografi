                    ...
                    <table class="w-full min-w-[500px]">
                        <thead>
                            <tr class="text-left">
                                ...
                                <th class="w-2/4 px-4 lg:px-6 py-4 text-[12px] font-semibold tracking-wide text-gray-500 uppercase">Deskripsi</th>
                            ...
                            <template x-if="services.length > 0">
                                <template x-for="item in services" :key="item.id">
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="w-2/4 px-4 lg:px-6 py-4 sm:py-5 align-top">
                                            <p class="text-[13px] lg:text-[14px] text-gray-500 whitespace-pre-line leading-relaxed" x-text="item.description || '-'"></p>
                                        </td>
