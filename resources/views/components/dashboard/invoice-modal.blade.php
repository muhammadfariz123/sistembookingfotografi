        ...
        <div @click.stop
            ...
            <div x-show="!loading" class="flex-1 overflow-y-auto no-scrollbar">
                ...
                <div class="px-6 py-5 border-b border-gray-100 bg-gray-50/50">
                        ...
                        <div x-show="invoiceType === 'dp'" class="mt-4 space-y-3">
                            ...
                            <template x-if="dpMethod === 'nominal'">
                                <div>
                                    ...
                                    <input type="text" :value="dpNominalFormatted"
                                        @input="handleDpNominalInput($event.target)" @focus="$event.target.select()"
                                        class="w-full h-[40px] rounded-xl border border-gray-300 px-4 text-[14px] focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <p class="text-[12px] text-blue-600 mt-1">
                                        Persentase: <span x-text="dpNominalPercent + '%'"></span>
                                    </p>
                                </div>
                            </template>
                            ...
                            <div class="bg-orange-50 rounded-xl p-3 text-[13px] space-y-1 border border-orange-100">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-red-600"
                                        x-text="formatRp(booking?.remaining ?? 0)"></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-green-50 rounded-xl p-3 text-[13px] space-y-1 border border-green-100">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-green-600"
                                        x-text="formatRp(booking?.total ?? 0)"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- INFO TIP -->
                    <div
                        class="mt-3 bg-yellow-50 border border-yellow-100 rounded-xl px-4 py-3 text-[12px] text-yellow-800">
                        ...
                        <div class="text-right space-y-1">
                            <div class="flex items-center gap-8 justify-end">
                                ...
                                <span class="text-[13px] font-medium text-gray-800"
                                    x-text="formatDateID(invoiceDate)"></span>
                            </div>
                            <div class="flex items-center gap-8 justify-end">
                                <span class="text-[12px] text-gray-500">Jatuh Tempo</span>
                                <span class="text-[13px] font-medium text-gray-800"
                                    x-text="formatDateID(invoiceDue)"></span>
                            </div>
                            <div class="flex items-center gap-8 justify-end">
                        ...
                        <tbody>
                            <tr class="border border-gray-200">
                                ...
                                <td class="px-4 py-4 text-right"
                                    x-text="formatDateShort(booking?.booking_date ?? booking?.start_date)"></td>
                        ...
                        <div class="w-full max-w-[340px] space-y-2 text-[13px]">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium"
                                    x-text="formatRp(booking?.subtotal ?? booking?.total ?? 0)"></span>
                            </div>
                            <template x-if="(booking?.discount_amount ?? 0) > 0">
                                <div class="flex justify-between">
                                    <span class="text-gray-500">Diskon:</span>
                                    <span class="font-medium text-red-500"
                                        x-text="'- ' + formatRp(booking?.discount_amount ?? 0)"></span>
                                </div>
                            </template>
                    ...
                    <div class="border border-gray-200 rounded-2xl p-5 mb-4">
                        ...
                        <div class="border-2 border-orange-300 rounded-xl p-4 text-center mb-4 bg-orange-50/50">
                            <p class="text-[12px] font-semibold text-orange-600 mb-1">
                                <span
                                    x-text="invoiceType === 'dp' ? 'Jumlah DP yang harus ditransfer' : invoiceType === 'pelunasan' ? 'Jumlah yang harus ditransfer' : 'Jumlah yang harus ditransfer'"></span>
                            </p>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    ...
                                    <template x-if="company?.bank_name">
                                        <div class="border border-gray-200 rounded-xl p-3 text-[13px]">
                                            ...
                                            <p><strong>No. Rekening:</strong> <span
                                                    x-text="company?.bank_account"></span></p>
                                    ...
                                    <template x-if="company?.bank_name_2">
                                        <div class="border border-gray-200 rounded-xl p-3 text-[13px]">
                                            ...
                                            <p><strong>No. Rekening:</strong> <span
                                                    x-text="company?.bank_account_2"></span></p>
...
<script>
    function invoiceModal() {
        return {
            ...
            get dpNominalFormatted() {
                return this.formatRp(this.dpNominal)
            },
            ...
            handleDpNominalInput(el) {
                ...
                this.dpNominal = raw === '' ? 0 : parseInt(raw)
                el.value = this.formatRp(this.dpNominal)
            },
