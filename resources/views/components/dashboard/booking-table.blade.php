...
<div x-data="bookingTable()" 
    ...
    class="bg-white w-full overflow-hidden">
    ...
    <div x-show="!loading" x-cloak class="overflow-x-auto">
        <table class="w-full min-w-[900px]">
            ...
            <tbody>
                ...
                {{-- State Kosong Jika Data 0 di Database --}}
                ...
                {{-- State Kosong Jika Hasil Pencarian Filter Tidak Ada --}}
                <template x-if="!loading && filteredBookings.length === 0 && bookings.length > 0">
                    <tr>
                        <td colspan="6">
                            <div class="h-[320px] flex flex-col items-center justify-center px-4 text-center">
                                ...
                                <p class="text-[13px] text-gray-400 mt-1">
                                    Coba ubah kata kunci pada kotak pencarian atau bersihkan filter.
                                </p>
                            </div>
                        </td>
                    </tr>
...
<script>
    function bookingTable() {
        return {
            ...
            // Fungsi ini dipanggil secara otomatis oleh Event Listener Alpine (@filter-changed.window)
            applyFilter(detail) {
            ...
            paymentClass(status) {
                switch (status) {
                    case 'Lunas': return 'bg-emerald-50 text-emerald-700 border-emerald-200'
                    case 'Down Payment': return 'bg-orange-50 text-orange-700 border-orange-200'
