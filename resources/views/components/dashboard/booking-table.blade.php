                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition">
                            ...
                            <td class="px-8 py-6 align-top">
                                ...
                                <p class="text-[13px] text-gray-500 mt-0.5"
                                    x-text="booking.client_contact || ''"></p>
                            ...
                            <td class="px-8 py-6 align-top">
                                ...
                                <p class="text-[13px] text-gray-500 mt-0.5"
                                    x-text="formatCurrency(booking.unit_price)"></p>
                                ...
                                <template x-if="booking.start_date">
                                    <div>
                                        ...
                                        <p class="text-[12px] text-gray-500 mt-0.5">
                                            s/d <span x-text="formatDate(booking.end_date)"></span>
                                        </p>
                                        <p x-show="booking.booking_time"
        ...
        get filteredBookings() {
            ...
            if (this.activeStatus && this.activeStatus !== 'semua') {
                ...
                result = result.filter(b =>
                    b.status === (map[this.activeStatus] ?? this.activeStatus)
                )
            }
            ...
            if (this.activePayment && this.activePayment !== 'semua') {
                ...
                result = result.filter(b =>
                    b.payment_status === (map[this.activePayment] ?? this.activePayment)
                )
            }
            ...
            switch (this.activeSortBy) {
                ...
                case 'date_asc':
                    result.sort((a, b) => {
                        const da = new Date(a.booking_date ?? a.start_date ?? 0)
                        const db = new Date(b.booking_date ?? b.start_date ?? 0)
                        return da - db
                    })
                    break
                case 'date_desc':
                ...
                case 'name_az':
                    result.sort((a, b) =>
                        (a.client_name ?? '').localeCompare(b.client_name ?? '', 'id')
                    )
                    break
            }
