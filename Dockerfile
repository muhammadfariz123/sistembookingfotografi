...
# Perintah otomatis saat server menyala (Jalankan migrasi aman lalu start server web)
CMD bash -c "php artisan migrate --force || true; php -S 0.0.0.0:${PORT:-10000} -t public"